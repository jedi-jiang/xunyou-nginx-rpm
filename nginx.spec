...
memory usage. 
This version was built by XUNYOU with lua extension.
...
./configure \
    ...
    --add-module="%{_builddir}/ngx_devel_kit-0.2.19" \
    --add-module="%{_builddir}/lua-nginx-module-0.9.12" \
    --with-debug \
...
%changelog
* Thu Nov 13 2014 Nick Jiang <jiangliangdong@classiclink.cn> - 1.0.15-10
- add lua extension
